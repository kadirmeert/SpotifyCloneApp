...
//                    print(result)
    ...
    // MARK: - PlayLists
    public func getPlaylistDetails(for playList: Playlists, completion: @escaping (Result<PlaylistDetailsResponse, Error>) -> Void) {
...
//                    print(result)
    ...
    public func getCategoryPlaylists(category: Category, completion: @escaping (Result<[Playlists], Error>) -> Void) {
